...
import { CatBaseComponent } from 'app/entities/cat-base/cat-base.component';
import { CatBaseService } from 'app/entities/cat-base/cat-base.service';
import { CatBase } from 'app/shared/model/cat-base.model';

describe('Component Tests', () => {
    describe('CatBase Management Component', () => {
        let comp: CatBaseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CatBaseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.catBases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
