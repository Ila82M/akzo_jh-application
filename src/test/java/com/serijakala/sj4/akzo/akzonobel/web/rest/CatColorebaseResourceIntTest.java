...
public class CatColorebaseResourceIntTest {
    ...
    @Autowired
    private CatColorebaseMapper catColorebaseMapper;
    ...
    public void createCatColorebase() throws Exception {
        ...
        CatColorebaseDTO catColorebaseDTO = catColorebaseMapper.toDto(catColorebase);
        restCatColorebaseMockMvc.perform(post("/api/cat-colorebases")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(catColorebaseDTO)))
    ...
    public void updateCatColorebase() throws Exception {
        ...
        updatedCatColorebase
            .resa(UPDATED_RESA);
        CatColorebaseDTO catColorebaseDTO = catColorebaseMapper.toDto(updatedCatColorebase);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(CatColorebaseDTO.class);
        CatColorebaseDTO catColorebaseDTO1 = new CatColorebaseDTO();
        catColorebaseDTO1.setId(1L);
        CatColorebaseDTO catColorebaseDTO2 = new CatColorebaseDTO();
        assertThat(catColorebaseDTO1).isNotEqualTo(catColorebaseDTO2);
        catColorebaseDTO2.setId(catColorebaseDTO1.getId());
        assertThat(catColorebaseDTO1).isEqualTo(catColorebaseDTO2);
        catColorebaseDTO2.setId(2L);
        assertThat(catColorebaseDTO1).isNotEqualTo(catColorebaseDTO2);
        catColorebaseDTO1.setId(null);
        assertThat(catColorebaseDTO1).isNotEqualTo(catColorebaseDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(catColorebaseMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(catColorebaseMapper.fromId(null)).isNull();
    }
}
