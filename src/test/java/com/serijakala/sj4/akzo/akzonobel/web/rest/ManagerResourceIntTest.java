...
public class ManagerResourceIntTest {
    ...
    private static final String DEFAULT_AREAMANAGER = "AAAAAAAAAA";
    private static final String UPDATED_AREAMANAGER = "BBBBBBBBBB";

    private static final String DEFAULT_AGENTE = "AAAAAAAAAA";
    private static final String UPDATED_AGENTE = "BBBBBBBBBB";

    private static final Long DEFAULT_NPUNTIVENDITA = 1L;
    private static final Long UPDATED_NPUNTIVENDITA = 2L;
    ...
    public static Manager createEntity(EntityManager em) {
        Manager manager = new Manager()
            ...
            .areamanager(DEFAULT_AREAMANAGER)
            .agente(DEFAULT_AGENTE)
            .npuntivendita(DEFAULT_NPUNTIVENDITA);
        return manager;
    }
    ...
    public void createManager() throws Exception {
        ...
        assertThat(testManager.getIduser()).isEqualTo(DEFAULT_IDUSER);
        assertThat(testManager.getAreamanager()).isEqualTo(DEFAULT_AREAMANAGER);
        assertThat(testManager.getAgente()).isEqualTo(DEFAULT_AGENTE);
        assertThat(testManager.getNpuntivendita()).isEqualTo(DEFAULT_NPUNTIVENDITA);
    }
    ...
    public void getAllManagers() throws Exception {
        ...
        restManagerMockMvc.perform(get("/api/managers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].areamanager").value(hasItem(DEFAULT_AREAMANAGER.toString())))
            .andExpect(jsonPath("$.[*].agente").value(hasItem(DEFAULT_AGENTE.toString())))
            .andExpect(jsonPath("$.[*].npuntivendita").value(hasItem(DEFAULT_NPUNTIVENDITA.intValue())));
    }
    ...
    public void getManager() throws Exception {
        ...
        restManagerMockMvc.perform(get("/api/managers/{id}", manager.getId()))
            ...
            .andExpect(jsonPath("$.areamanager").value(DEFAULT_AREAMANAGER.toString()))
            .andExpect(jsonPath("$.agente").value(DEFAULT_AGENTE.toString()))
            .andExpect(jsonPath("$.npuntivendita").value(DEFAULT_NPUNTIVENDITA.intValue()));
    }
    ...
    public void updateManager() throws Exception {
        ...
        updatedManager
            ...
            .areamanager(UPDATED_AREAMANAGER)
            .agente(UPDATED_AGENTE)
            .npuntivendita(UPDATED_NPUNTIVENDITA);
        ...
        Manager testManager = managerList.get(managerList.size() - 1);
        assertThat(testManager.getIduser()).isEqualTo(UPDATED_IDUSER);
        assertThat(testManager.getAreamanager()).isEqualTo(UPDATED_AREAMANAGER);
        assertThat(testManager.getAgente()).isEqualTo(UPDATED_AGENTE);
        assertThat(testManager.getNpuntivendita()).isEqualTo(UPDATED_NPUNTIVENDITA);
    }
