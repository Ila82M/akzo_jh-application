...
public class CatProdottoResourceIntTest {
    ...
    @Autowired
    private CatProdottoMapper catProdottoMapper;
    ...
    public void createCatProdotto() throws Exception {
        ...
        CatProdottoDTO catProdottoDTO = catProdottoMapper.toDto(catProdotto);
        restCatProdottoMockMvc.perform(post("/api/cat-prodottos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(catProdottoDTO)))
    ...
    public void updateCatProdotto() throws Exception {
        ...
        CatProdottoDTO catProdottoDTO = catProdottoMapper.toDto(updatedCatProdotto);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(CatProdottoDTO.class);
        CatProdottoDTO catProdottoDTO1 = new CatProdottoDTO();
        catProdottoDTO1.setId(1L);
        CatProdottoDTO catProdottoDTO2 = new CatProdottoDTO();
        assertThat(catProdottoDTO1).isNotEqualTo(catProdottoDTO2);
        catProdottoDTO2.setId(catProdottoDTO1.getId());
        assertThat(catProdottoDTO1).isEqualTo(catProdottoDTO2);
        catProdottoDTO2.setId(2L);
        assertThat(catProdottoDTO1).isNotEqualTo(catProdottoDTO2);
        catProdottoDTO1.setId(null);
        assertThat(catProdottoDTO1).isNotEqualTo(catProdottoDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(catProdottoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(catProdottoMapper.fromId(null)).isNull();
    }
}
